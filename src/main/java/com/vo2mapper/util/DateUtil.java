...
public class DateUtil {
	...
	public static void main(String[] args) {
		...
		Date date = new Date();
		System.out.println(DateUtil.addDay(date, 1).toLocaleString());
		System.out.println(DateUtil.addDay(date, 7).toLocaleString());
		System.out.println(DateUtil.format(DateUtil.addDay(date, 1), FORMAT_SHORT));
